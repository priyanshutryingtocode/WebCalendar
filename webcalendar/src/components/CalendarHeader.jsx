...
export default function CalendarHeader({ currentDate, onPrevMonth, onNextMonth, direction }) {
  ...
  return (
    <div 
  className="relative w-full h-70 overflow-hidden bg-gray-200"
      ...
      >
        <div className="absolute bottom-6 right-8 text-right text-white flex flex-col items-end">
          ...
          <div className="flex items-center gap-4 -mb-1">
            ...
            {/* Animated Year */}
            <div className="text-xl tracking-widest font-light relative h-8 overflow-hidden flex items-center justify-end min-w-17.5">
          ...
          {/* Animated Month */}
          <div className="text-3xl font-bold tracking-widest uppercase relative h-10 overflow-hidden flex items-center justify-end min-w-50">
             <AnimatePresence mode="popLayout" custom={direction}>
                <motion.div
